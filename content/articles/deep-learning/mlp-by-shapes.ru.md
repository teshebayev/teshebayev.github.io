...
<p class="stage-hint">Наведите фокус на сцену и листайте стрелками ← →.</p>
<div class="callout">
  <strong>Главная мысль части:</strong> обратный проход — не «магия обучения», а тот же матричный конвейер справа налево; начинается он с <code>(P − Y) / B</code>, а формы градиентов повторяют формы величин.
</div>

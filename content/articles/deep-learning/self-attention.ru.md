...
<strong>Главная мысль части:</strong> всё прочитанное RNN передаёт дальше только через один
  вектор <code>hidden_5</code> фиксированного размера, сколько бы слов ни было во фразе.

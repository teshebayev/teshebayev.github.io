...
<p class="stage-hint">Наведите фокус на сцену и листайте стрелками ← →.</p>
<div class="callout">
  <strong>Главная мысль части:</strong> max-пулинг на обратном пути — маршрутизатор: градиент окна идёт в запомненного победителя, а вместе с ReLU оставляет ненулевыми лишь малую часть клеток.
</div>
